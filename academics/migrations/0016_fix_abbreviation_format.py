# Generated by Django 6.0 on 2026-01-22 09:05

from django.db import migrations


def fix_abbreviation_format(apps, schema_editor):
    """Corriger le format des abréviations (YYMMM → MMYY)."""
    ...
    for cohort in Cohort.objects.all():
        try:
            ...
            # Récupérer l'année et le mois en MMYY (correct)
    ...
    print(f"✅ {updated_count} cohorts ont été corrigés avec le bon format MMYY")


def reverse_fix(apps, schema_editor):
    """Reverse: vider les abréviations."""
    Cohort = apps.get_model('academics', 'Cohort')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('academics', '0015_populate_abbreviations'),
    ]

    operations = [
        migrations.RunPython(fix_abbreviation_format, reverse_fix),    ]